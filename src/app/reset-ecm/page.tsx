          ...
          <div className="mb-6">
            {tool && (
              <button
                ...
                className="mb-3 flex items-center gap-1.5 text-sm text-[#9aa1ac] transition hover:text-white"
              >
                ← Voltar
              </button>
            )}
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl border border-[#ff8c3f]/30 bg-[#ff8c3f]/10 text-2xl">
                🔄
              </div>
              <div>
                <h1 className="text-2xl font-extrabold text-white">Reset / Inicialização ECM</h1>
                <p className="text-sm text-[#9aa1ac]">Honda CG160 Fan ESDi · CG160 Titan EX</p>
              </div>
            </div>
          </div>
          ...
          {!tool && (
            <div className="space-y-3">
              <button
                ...
                className="group w-full rounded-2xl border border-blue-500/30 bg-[#111317] p-5 text-left transition hover:border-blue-500/60 hover:bg-blue-500/5"
              >
                <div className="flex items-start gap-4">
                  ...
                  <span className="text-[#6c727c] transition group-hover:text-white">→</span>
                </div>
              </button>

              <button
                onClick={() => setTool("reset-combustivel")}
                className="group w-full rounded-2xl border border-purple-500/30 bg-[#111317] p-5 text-left transition hover:border-purple-500/60 hover:bg-purple-500/5"
              >
                <div className="flex items-start gap-4">
              ...
              <button
                ...
                className="group w-full rounded-2xl border border-[#ff8c3f]/30 bg-[#111317] p-5 text-left transition hover:border-[#ff8c3f]/60 hover:bg-[#ff8c3f]/5"
              >
                <div className="flex items-start gap-4">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-[#ff8c3f]/30 bg-[#ff8c3f]/10 text-2xl">
                    💡
                  </div>
                  <div className="flex-1">
                    <p className="text-xs font-bold uppercase tracking-widest text-[#ff8c3f]">Referência</p>
                    ...
                    <div className="mt-2 flex flex-wrap gap-1.5">
                      {["Padrão A", "Padrão B", "Padrão C", "Padrão D", "% Etanol"].map((t) => (
                        <span key={t} className="rounded-full border border-[#ff8c3f]/30 bg-[#ff8c3f]/10 px-2.5 py-0.5 text-xs font-semibold text-[#ff8c3f]">{t}</span>
                      ))}
                    </div>
                  </div>
                  <span className="text-[#6c727c] transition group-hover:text-white">→</span>
